...
sub get_runnable {
  ...
  sub {
    print "About to process X-Tandem ... \n";

    for ( @runs ) {
      $_->() if ref eq 'CODE';
    }

    print "Done processing: X-Tandem \n";
  };
...
<bioml>
	...
	<note type="input" label="protein, taxon">homo.sapien</note>
...
<note>spectrum parameters</note>
	<note type="input" label="spectrum, fragment monoisotopic mass error">1</note>
