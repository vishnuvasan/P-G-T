...
This command is similar to pepmerge, execept pepmerge merges outputs 
from several search engines OMSSA, XTandem etc.. Collate takes as input
several pepmerge files generated from several independent searches and 
produces a merged output.
